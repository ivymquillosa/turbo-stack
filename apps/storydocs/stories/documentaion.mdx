...
<div style={{borderBottom:'solid 1px #db492c', display:'flex', padding:'10px', marginBottom: '20px'}}>
    ...
    <div style={{padding:'20px'}}>
        <h1 style={{ margin: 0 }}>Ivy Marie R. Quillosa</h1>
...
<h5 style={{ marginTop: '40px'}}> Note: This project is still under development, but you can check the complete source code [here](https://github.com/ivymquillosa/turbo-stack/tree/development).</h5>import { FiGithub } from "react-icons/fi"
