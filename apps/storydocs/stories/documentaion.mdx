...
<Meta title="Documentaion"/>


<div style={{borderBottom:'solid 1px #db492c', display:'flex', padding:'10px', marginBottom: '20px'}}>
    <img 
        height={180}
        width={180}
        src='https://avatars.githubusercontent.com/u/72949747?v=4'
        style={{borderRadius: '50%', border: 'solid 4px #db492c'}}
    />
    <div style={{padding:'20px'}}>
        <h1 style={{ margin: 0, fontSize: '38px' }}>Ivy Marie R. Quillosa</h1>
        <h4 style={{margin: 0, padding: '2px 0', borderBottom: 'solid 1px #dce3e9'}}>Software Engineer | Front-end Developer</h4>
        <div style={{ display: 'flex', padding: '4px 0', gap: 8, color:'#2E3438', alignItems: 'center'}}>
          <a
           style={{ display: 'flex', height: '10px', gap: 4, color:'#2E3438', alignItems: 'center'}}
            href="https://github.com/ivymquillosa"
            target="_blank"
          >
            <span>
         ...
         <h5 style={{margin:0, lineHeight: '10px', color: '#dce3e9'}}>|</h5>
          <a
            style={{ display: 'flex', height: '10px', gap: 4, color:'#2E3438', alignItems: 'center'}}
            href="https://www.linkedin.com/in/ivy-marie-quillosa-a678bb195/"
            target="_blank"
          >
            <span>
...
- ☁️ [Vercel](https://vercel.com/) — Cloud platform for static sites and serverless functions
...
<h5 style={{ marginTop: '40px'}}> Note: This project is still under development, but you can check the complete source code [here](https://github.com/ivymquillosa/turbo-stack/tree/development).</h5>
