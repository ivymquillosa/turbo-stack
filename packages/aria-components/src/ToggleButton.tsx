...
const toggleStyles = {
  ...
  variant: {
    flat: {
      primary:
        'bg-transparent selected:bg-primary-50 hover:bg-primary-50 text-primary-500',
      secondary:
        'bg-transparent selected:bg-secondary-50 hover:bg-secondary-50 text-secondary-500',
      light:
        'bg-transparent selected:bg-light-50 hover:bg-light-50 text-light-500',
      dark: 'bg-transparent selected:bg-dark-50 hover:bg-dark-50 text-dark-500',
      default:
        'bg-transparent selected:bg-default-50 hover:bg-default-50 text-default-500',
      success:
        'bg-transparent selected:bg-success-50 hover:bg-success-50 text-success-500',
      warning:
        'bg-transparent selected:bg-warning-50 hover:bg-warning-50 text-warning-500',
      danger:
        'bg-transparent selected:bg-danger-50 hover:bg-danger-50 text-danger-500',
      info: 'bg-transparent selected:bg-info-50 hover:bg-info-50 text-info-500',
      active:
        'bg-transparent selected:bg-active-50 hover:bg-active-50 text-active-500'
    },
    solid: {
      primary:
    ...
    soft: {
      primary:
        'bg-primary-100 selected:bg-primary-200 hover:bg-primary-200 text-primary-500',
      secondary:
        'bg-secondary-100 selected:bg-secondary-200 hover:bg-secondary-200 text-secondary-500',
      light:
        'bg-default-50 selected:bg-default-100 hover:bg-default-100 text-light-700',
      dark: 'bg-dark-100 selected:bg-dark-200 hover:bg-dark-200 text-dark-500',
      default:
        'bg-default-100 selected:bg-default-200 hover:bg-default-200 text-default-500',
      success:
        'bg-success-100 selected:bg-success-200 hover:bg-success-200 text-success-500',
      warning:
        'bg-warning-100 selected:bg-warning-200 hover:bg-warning-200 text-warning-500',
      danger:
        'bg-danger-100 selected:bg-danger-200 hover:bg-danger-200 text-danger-500',
      info: 'bg-info-100 selected:bg-info-200 hover:bg-info-200 text-info-500',
      active:
        'bg-active-100 selected:bg-active-200 hover:bg-active-200 text-active-500'
    }
  },
  radius: {
    none: 'rounded-none',
